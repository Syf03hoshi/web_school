...
<head>
  ...
  <title>Halaman Update Informasi</title>
...
<body>
  ...
  <?php
    ...
    $query = "SELECT * FROM tbl_informasi WHERE id = $id";
    // Hasil Query
  ...
  <section class="row">
    <div class="col-md-6 offset-md-3 align-self-center"> 
      ...
      <form method="POST">
        ...
        <a href="news.php" type="button" class="btn btn-info text-white">Kembali</a>
      </form>
    </div>
  </section>
  ...
  <?php
    ...
    if(isset($_POST['daftar'])){
      ...
      // Membuat Query
      $query = "UPDATE tbl_informasi SET judul = '$judul', isi = '$isi', create_at = '$create_at' WHERE id = '$id'";
