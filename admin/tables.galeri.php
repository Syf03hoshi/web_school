                    ...
                    <div class="card shadow mb-4">
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <th scope='row'>". $no++ ."</th>
                                <td>
                                <img src='gambar/" . $row['fotogbr'] . "'>
                                </td>
                                <td> 
                                <a href='galeri.del.php?id=".$row["idgambar"]."' type='button' class='btn btn-danger' onlick='return confirm('Yakin ingin menghapus data?')'>Delete</a>
                              </td>
                                </tr>  <br>";
                            }
                        } else {
